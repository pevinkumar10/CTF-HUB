<?php
// getting all the products for list an item in add cart.
    ...
    <section class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 mt-5 pt-5">
                <?php if (array_key_exists($product, $all_product_details['tea'])) { ?>
                ...
                ?>
                    <div class="container">
                        ...
                        <div class="message text-white">Requested Product not found.</div>
