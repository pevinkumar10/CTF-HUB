<div class="d-flex py-3 float-end mx-auto">
    <ul class="nav nav-pills mx-3">
        ...
        <a class="text-decoration-none" href="/products.php"><button type="button" class="nav-item btn btn-outline-warning mx-2 px-3">Buy</button></a>
        <a class="text-decoration-none" href="#"><button type="button" class="nav-item btn btn-outline-warning mx-2 px-3">Faq</button></a>
