<div class="pt-3">
    ...
    <div class="container pb-5">
        <div class="row g-4">
            ...
            <div class="col-md-3">
                <div class="card bg-dark border border-warning text-white h-100">
                    <img src="img/butter-tea.jpg" class="card-img-top" alt="Herbal Fusion">
                    <div class="card-body">
                        <h5 class="card-title text-warning">Butter Tea</h5>
    ...
    <div class="container pb-5">
        <div class="row g-4">
            ...
            <div class="col-md-3">
                <div class="card bg-dark border border-warning text-white h-100">
                    <img src="img/green-chai.jpg" class="card-img-top" alt="Green Chai">
                    <div class="card-body">
                        <h5 class="card-title text-warning">Green Chai</h5>
