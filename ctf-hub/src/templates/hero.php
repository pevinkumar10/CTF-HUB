<div class="container col-xxl-8 px-5 py-5 min-vh-100">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        ...
        <div class="col-lg-6">
            <h1 class="display-5 fw-bold text-body-emphasis lh-1 mb-3">A WARM CUP FOR EVERY LINE OF CODE</h1>
            <p class="lead" style="color: #ffc107;">Take a break, clear your mind, and enjoy a cup of chai. Whether you're debugging or building your next big idea, we're here to keep you refreshed and inspired.</p>
